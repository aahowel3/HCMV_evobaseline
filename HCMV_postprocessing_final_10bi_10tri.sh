...
Rscript ../HCMV_postprocessing_final_10bi_10tri.R $file congenital_plasma.${strip}.1000.output.ms congenital_urine.${strip}.100.output.ms congenital_urine.${strip}.1000.output.ms  >> 10bi_10tricombos_2.csv
